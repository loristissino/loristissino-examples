program tree11(Input,Output);

{
  * aggiungiamo una procedura per l'eliminazione di un nodo, noto l'id
  * del nodo padre e quello del nodo da eliminare
  * 
  * dobbiamo garantire la coerenza della catena dei nodi fratelli
  * ed evitare che vengano eliminati nodi con figli
  * }
