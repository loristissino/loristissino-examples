program tree12(Input,Output);

{
  * aggiungiamo una procedura per la ricerca del nodo padre di un nodo
  * di cui conosciamo l'id
  * 
  * }
  ...
  begin
   ...
   begin {main}
    ...
    f:=findParentById(t, 7);
    if f<>nil then
      writeln(f^.name)
    else
      writeln('No parent found');
