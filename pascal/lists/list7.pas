...
{
  partendo da list6.pas, aggiungiamo il codice 
  per visualizzare gli elementi della lista in ordine 
  inverso, però provvisoriamente sospendiamo la parte
  interattiva per uno sviluppo più comodo.
}
